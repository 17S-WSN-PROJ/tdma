...
AVRDUDE_FLAGS = -b 57600 -F -p atmega128 -P $(PROGRAMMING_PORT) -c $(AVRDUDE_PROGRAMMER)
else
...
altprog: $(TARGET).hex
	avrdude-5.0 -b 115200 -F -p atmega128 -P $(PROGRAMMING_PORT) -c avr109 $(AVRDUDE_WRITE_FLASH)
