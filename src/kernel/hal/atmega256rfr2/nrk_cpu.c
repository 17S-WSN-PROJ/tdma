...
*/
    --stk;
    stkc = (unsigned char*)stk;	
    // The top most byte of the function will likely be 0.
    // This will not work for functions that have addresses
    // larger then the 16-bit size of the function pointers.
    // Not exactly sure how to fix this, maybe with EIND?
    *stkc++ = (unsigned char)((unsigned int)(task)/ 4096);
...
unsigned char *stkc;
    ...
    #endif
	// See comment above about upper most byte...
    *stkc++ = (uint16_t)((uint16_t)_nrk_timer_tick>>16);
