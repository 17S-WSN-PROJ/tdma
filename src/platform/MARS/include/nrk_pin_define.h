...
// Port D
#define BUTTON          1  // PA.7 - Input button 0
#define UART1_RXD       2 // PD.2 - Input:  UART1 RXD
#define UART1_TXD       3 // PD.3 - Output: UART1 TXD
#define LED_0           4 // PD.4 - Output: RED LED
#define LED_1           5 // PD.5 - Output: GREEN LED
#define LED_2           6 // PD.6 - Output: ORANGE LED
#define LED_3           7 // PD.7 - Output: BLUE LED
